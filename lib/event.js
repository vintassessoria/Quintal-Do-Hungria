...
export const TOUR_DATES = [
  ...
  },
  {
    ...
    city: 'Curitiba',
    venue: 'Live Curitiba',
    status: 'confirmed', // vendas abertas, mas a PRÓXIMA parada segue sendo RP
    ticketUrl: 'https://checkout2.bilheteriadigital.com/quintal-do-hungria-19-de-setembro', // Bilheteria Digital
  },
  {
    id: 'bh',
    day: '24',
    ...
    status: 'confirmed', // vendas abertas — RP segue como próxima parada
    ticketUrl: 'https://baladapp.com.br/evento/quintal-do-hungria-belo-horizonte-mg/9083?cod=INSTA', // BaladAPP
  },
  {
    id: 'brasilia',
    day: null,
...
export const FAQ = [
  ...
  {
    q: 'Onde será a edição de Curitiba?',
    a: 'Na Live Curitiba — Rua Itajubá, 143, Portão, Curitiba/PR — no dia 19 de setembro. A casa abre às 21h e o evento é para maiores de 18 anos.',
  },
  {
  ...
  },
  {
    ...
    a: 'Ribeirão Preto: pela GuichêWeb. Curitiba: pela Bilheteria Digital. Belo Horizonte: pela BaladAPP. Use sempre os links oficiais aqui do site.',
  },
  {
