...
// Link do mapa / localização (Google Maps) — Live Curitiba, Rua Itajubá, 143, Portão, Curitiba/PR.
export const MAP_URL =
  'https://www.google.com/maps/search/?api=1&query=Live+Curitiba,+Rua+Itajub%C3%A1,+143,+Port%C3%A3o,+Curitiba+-+PR';
// Embed (sem chave de API) usado no mapa interativo da seção Localização.
export const MAP_EMBED_URL =
  'https://www.google.com/maps?q=Live+Curitiba,+Rua+Itajub%C3%A1,+143,+Curitiba&z=15&hl=pt-BR&output=embed';
