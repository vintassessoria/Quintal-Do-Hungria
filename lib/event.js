...
// Link do mapa / localização (Google Maps) — Arena NicNet, Ribeirão Preto.
export const MAP_URL =
  'https://www.google.com/maps/search/?api=1&query=-21.2023659,-47.7902054';
// Embed (sem chave de API) usado no mapa interativo da seção Localização.
export const MAP_EMBED_URL =
  'https://www.google.com/maps?q=-21.2023659,-47.7902054&z=16&hl=pt-BR&output=embed';
...
export const EVENT = {
  ...
  dateShort: '25 JUL',
  weekday: 'Sábado',
  venue: 'Estacionamento Arena NicNet',
  venueShort: 'Arena NicNet',
  doorsTime: '17H',
...
export const NIGHT_JOURNEY = [
  {
    ...
    text: 'A experiência começa com a chegada do público e a atmosfera do pôr do sol tomando conta da Arena NicNet.',
  },
  {
    marker: '360°',
  ...
  },
  {
    ...
    text: 'O ápice da noite: 3 horas exclusivas de Hungria no palco — o auge das 6 horas de experiência.',
  },
];
...
export const FAQ = [
  {
    q: 'Onde será realizado o Quintal do Hungria?',
    a: 'No Estacionamento Arena NicNet, em Ribeirão Preto.',
  },
  {
    q: 'Qual a data do evento?',
    a: 'O evento acontece no dia 25 de julho.',
  },
  {
    q: 'Que horas começa o evento?',
    a: 'A abertura está prevista para às 17h.',
  },
  {
